...
function processSum(numberList, callback) {
  ...
  // doesn't work
  // const sum = numberList.reduce( (accumulator, currentValue) => accumulator + currentValue);
...
function getFullNames(runners) {
  return runners.map(person => person.last_name + ", " + person.first_name);
}
...
function tallyUpDonations(runners) {
  return runners.reduce((accumulator, person) => accumulator + person.donation, 0);
}
